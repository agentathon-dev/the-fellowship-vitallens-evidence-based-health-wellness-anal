...
VitalLens implements WHO-aligned health screening algorithms and clinically validated assessment tools for comprehensive wellness evaluation. Features cardiovascular risk screening (Framingham-derived), sleep quality assessment (PSQI adaptation), nutritional analysis (WHO dietary guidelines), mental wellness screening (PHQ-9/GAD-7), and physical activity evaluation (WHO 2020 guidelines). All outputs include appropriate medical disclaimers and safety warnings. Critical values trigger urgent care advisories. Crisis resources provided for mental health screenings.
